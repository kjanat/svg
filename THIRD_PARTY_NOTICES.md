...
- **Source:** [web-platform-dx/web-features](https://github.com/web-platform-dx/web-features)
  Baseline logos, distributed via
  <https://web-platform-dx.github.io/name-and-logo-usage-guidelines/>
- **Copyright:** Google LLC. "Baseline" and its logos are trademarks of
  Google.
- **License:**
...
- **Notes:** The guidelines prohibit modifying, distorting, or recoloring the
  ...
  differently for each build target); do not hand-edit one without checking
  the other stays visually identical. See
  [issue #36](https://github.com/kjanat/svg/issues/36) for open follow-up
  work on this (re-vendoring from the canonical source, deduplicating the two
  copies).
