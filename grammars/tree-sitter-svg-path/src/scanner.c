...
void tree_sitter_svg_path_external_scanner_destroy(void *payload) {}
unsigned tree_sitter_svg_path_external_scanner_serialize(void *payload, char *buffer) { return 0; }
