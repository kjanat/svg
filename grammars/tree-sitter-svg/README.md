...
[![NPM](https://img.shields.io/npm/v/tree-sitter-svg?logo=npm&labelColor=CB3837&color=black)](https://npm.im/tree-sitter-svg)
...
```swift
.package(url: "https://github.com/kjanat/svg", from: "0.1.2")
```
